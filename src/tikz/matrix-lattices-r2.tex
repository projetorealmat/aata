...
\node [above] at (square) {Reticulado quadrado};
...
\node [above] at (rectangular) {Reticulado retangular};
...
\node [above] at (rhombic) {Reticulado rômbico};
...
\node [above] at (parallelogram) {Reticulado de paralelogramos};
...
\node [above] at (hexagonal) {Reticulado hexagonal}; %Couldn't figure out an elegant way to do the hexagonal lattice - TWJ 6/14/2010
